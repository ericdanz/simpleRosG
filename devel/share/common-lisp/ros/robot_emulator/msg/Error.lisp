...
(cl:defmethod cl:initialize-instance :after ((m <Error>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Error)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_emulator-msg:<Error> is deprecated: use robot_emulator-msg:Error instead.")))

(cl:ensure-generic-function 'error-val :lambda-list '(m))
(cl:defmethod error-val ((m <Error>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_emulator-msg:error-val is deprecated.  Use robot_emulator-msg:error instead.")
  (error m))
