...
cd "/home/ed/Dropbox/GitHub/simpleRosG/src/rosserial/rosserial_python"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/ed/Dropbox/GitHub/simpleRosG/src/rosserial/rosserial_python/setup.py" \
    build --build-base "/home/ed/Dropbox/GitHub/simpleRosG/build/rosserial/rosserial_python" \
    install \
    $DESTDIR_ARG \
