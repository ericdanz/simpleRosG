...
cd "/home/ed/Dropbox/GitHub/simpleRosG/src/rosserial/rosserial_client"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/ed/Dropbox/GitHub/simpleRosG/src/rosserial/rosserial_client/setup.py" \
    build --build-base "/home/ed/Dropbox/GitHub/simpleRosG/build/rosserial/rosserial_client" \
    install \
    $DESTDIR_ARG \
